...
<template>
  <BaseOverlay :clip-path="clipPath">
    <img src="../images/single8x7/logo.png" class="logo" />
      <GameInfo run-type="single8x7"/>
      <div class="discordBox"></div>
      <TimerAndEstimate/>
      <div class="player_display_outer">
